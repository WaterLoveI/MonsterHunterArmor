...
{
    public class BnahabraBrown : ModNPC
    {
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            if (NPC.life <= 0)
            {
                ...
                {
                    Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("BnahabraBrown1").Type, 1f);
                    Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("BnahabraBrown2").Type, 1f);
                }
            }
        }
        ...
        {
            return (spawnInfo.Player.ZoneJungle || spawnInfo.Player.ZoneDesert) && !spawnInfo.Water &&
