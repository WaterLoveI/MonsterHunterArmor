...
{
    public class StunnedDrawLayer : PlayerDrawLayer
    {
        ...
        public override bool GetDefaultVisibility(PlayerDrawSet drawInfo) =>
            ...
            && drawInfo.shadow == 0
            && (drawInfo.drawPlayer.HasBuff(ModContent.BuffType<Stunned>()));
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("MHArmorSkills/PlayerDrawLayers/DizzyStars", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
