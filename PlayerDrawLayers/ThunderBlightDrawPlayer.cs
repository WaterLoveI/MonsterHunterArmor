...
namespace MHArmorSkills.PlayerDrawLayers
{
    public class ThunderBlightDrawPlayer : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet drawInfo)
        {
            ...
            Texture2D texture = ModContent.Request<Texture2D>("MHArmorSkills/PlayerDrawLayers/ThunderBlightDrawPlayer", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
