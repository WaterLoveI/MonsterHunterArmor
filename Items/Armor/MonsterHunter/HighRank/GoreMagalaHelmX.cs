...
namespace MHArmorSkills.Items.Armor.MonsterHunter.HighRank
{
    ...
    public class GoreMagalaHelmX : ModItem
    {
            
        public static readonly int Damage = 12;
        public static readonly int Crit = 12;
        public static readonly int Resentment = 3;
        public static readonly int Bloodlust = 1;
        public static readonly int Decor2 = 1;
        public override LocalizedText Tooltip => base.Tooltip.WithFormatArgs(Damage, Crit, Resentment, Bloodlust, Decor2);
