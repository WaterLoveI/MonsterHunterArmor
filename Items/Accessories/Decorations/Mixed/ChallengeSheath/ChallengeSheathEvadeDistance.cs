...
namespace MHArmorSkills.Items.Accessories.Decorations.Mixed.ChallengeSheath
{
    public class ChallengeSheathEvadeDistance : ModItem
    {
        ...
        public override void UpdateEquip(Player player)
        {
            ...
            modPlayer.ChallengeSheatheCloseRangeUp += 1;
