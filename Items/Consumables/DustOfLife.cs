...
{
    public class DustOfLife: ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.maxStack = 9999;
            Item.healLife = 125; // Modify this value to change the amount healed
        ...
        {
            CreateRecipe().
                AddIngredient<LifePowder>().
                AddIngredient(ItemID.ChlorophyteOre, 3).
